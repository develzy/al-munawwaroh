...
try {
    console.log('Creating Syahriah and Infaq tables...');
    const output = execSync(`node node_modules/wrangler/bin/wrangler.js d1 execute ${dbName} --remote --file migration_keuangan.sql -y`, {
        env: {
            ...process.env,
