...
try {
    console.log('Updating santri table structure...');
    const output = execSync(`node node_modules/wrangler/bin/wrangler.js d1 execute ${dbName} --remote --file migration_santri_detail.sql -y`, {
        env: {
            ...process.env,
